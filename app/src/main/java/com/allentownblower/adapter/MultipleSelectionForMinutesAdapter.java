 ...
 */
public class MultipleSelectionForMinutesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    ArrayList<MultipleSelection> multipleSelections;
    private Activity act;

    public MultipleSelectionForMinutesAdapter(Activity act, ArrayList<MultipleSelection> multipleSelections) {
        this.act = act;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        ((ItemHolder) holder).txt_MultipleSelection_Option.setText(object.getName()+ " Minute");
